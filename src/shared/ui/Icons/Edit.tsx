...
export const Edit = ({ className }: Props) => {
    return (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" className={clsx({className: className})} xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M10.625 5L15 9.375" stroke="white" strokeWidth="1.5" strokeLinecap="round"
                  strokeLinejoin="round"/>
            <path d="M7.46011 16.8351L3.16479 12.5398" stroke="white" strokeWidth="1.5" strokeLinecap="round"
                  strokeLinejoin="round"/>
        </svg>
