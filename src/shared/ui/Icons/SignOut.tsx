...
export const SignOut = ({ className }: Props) => {
    return (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" className={clsx({className: className})} xmlns="http://www.w3.org/2000/svg">
            <path d="M13.5947 6.71875L16.8751 10L13.5947 13.2812" stroke="white" strokeWidth="1.5"
                  strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M8.125 10H16.8727" stroke="white" strokeWidth="1.5" strokeLinecap="round"
